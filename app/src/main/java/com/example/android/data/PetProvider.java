...
public class PetProvider extends ContentProvider {
   ...
   // Data Base Helper Object
    ...
    static {
        ...
        sUriMatcher.addURI(PetContract.CONTENT_AUTHORITY,PetContract.PATH_PETS+"/#",PET_ID);     // '#' here represents any length of Integer, for the uriMatcher to match a pattern
    }
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            ...
            case PET_ID:
                ...
                selectionArgs = new String[] { String.valueOf(ContentUris.parseId(uri)) };  // This will return the integer (ID here) at the last of URI
    ...
    private int updatePet(Uri uri, ContentValues contentValues, String selection, String[] selectionArgs) {
        ...
        if(contentValues.containsKey(PetContract.PetEntry.COLUMN_PET_NAME) == true)
        {
            String petName = contentValues.getAsString(PetContract.PetEntry.COLUMN_PET_NAME);
            if(petName == null) throw new IllegalArgumentException("Pet requires A Name. Can't be NULL");
        }
